...
> 日期：2026-08-21
> 包：`auto-era-art-contract-sample-v0.1.0.unitypackage`
> 导出大小：287512 bytes
...
- `Assets/Game/Prefabs/AutoEra/ContractSample/`
- `Assets/Game/Materials/AutoEra/ContractSample/`
- `Assets/Game/Config/AutoEra/ContractSample/`

首次导入前主工程中不存在两个样例Prefab。导入后2个Prefab、6个Material和1个TextAsset均位于声明路径，9/9 GUID与`ArtResource`清单一致。

## 结构与依赖

- 两个Prefab已实例化到`Assets/Game/Scene/AutoEra/ArtValidation/ART001_ImportValidation.unity`，形成主工程侧既有绑定。
