...
|---|---|---|---|---|---|---|---|
| `b02-parallel-program-p0003-p0006-runtime-foundations` | `P0-003`～`P0-006` | 程序（客户端）；测试后续验收 | 实施中 | — | 既有精确写锁继续由客户端保留；其他窗口文档与用户任务表严格排除 | 主工程8090仍由客户端保留，未进PlayMode | 第15段已由制作人代为提交：`ac37c44`；WorldClock EditMode 3/3通过，可继续下一实施段 |
