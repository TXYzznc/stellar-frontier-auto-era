...
{
    /// <summary>
    /// AlertForm 的 GF 桥。结构由 Docs/Development/UI-PrefabLayouts/AlertForm.contract.json 生成
    ...
    public sealed partial class AlertForm : AutoEraShellFormBase
    {
        ...
        protected override void OnAutoEraOpen()
        {
            ...
            ShowPageUnavailable(NotWiredReason, _alertsLoadingState, _alertsEmptyState, _alertsErrorState, _alertsSuccessState, _alertsDisabledState, _alertsListBody, _alertsDetailBody);
