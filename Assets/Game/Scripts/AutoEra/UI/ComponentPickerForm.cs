...
{
    /// <summary>
    /// ComponentPickerForm 的 GF 桥。结构由 Docs/Development/UI-PrefabLayouts/ComponentPickerForm.contract.json 生成
    /// （设计来源：Docs/GameDesign/03-玩家体验/界面规格）。
    ///
    /// 绑定字段在同名的 ComponentPickerForm.Fields.cs 里（同一 partial 类）；本文件只有类逻辑：
    ...
    public sealed partial class ComponentPickerForm : AutoEraShellFormBase
    {
        ...
        protected override void OnAutoEraOpen()
        {
            ...
            ShowPageUnavailable(NotWiredReason, _componentPickerLoadingState, _componentPickerEmptyState, _componentPickerErrorState, _componentPickerSuccessState, _componentPickerDisabledState, _componentPickerCandidatesBody, _componentPickerComparisonBody);
