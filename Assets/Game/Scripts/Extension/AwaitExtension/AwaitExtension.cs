...
public static class AwaitExtension
{
    ...
    /// 打开界面（可等待）
    /// </summary>
    public static UniTask<EntityLogic> ShowEntityAwait<T>(
        ...
        where T : EntityLogic
    {
        ...
        entityComponent.ShowEntity<T>(prefabName, groupName, priority, entityId, userData);
    ...
    /// 显示实体（可等待）
    /// </summary>
    public static UniTask<EntityLogic> ShowEntityAwait(
        this EntityComponent entityComponent,
        int entityId,
        string prefabName,
        ...
        object userData = null)
    {
        ...
        var tcs = new UniTaskCompletionSource<EntityLogic>();
        mEntityTask.Add(entityId, tcs);
        entityComponent.ShowEntity(prefabName, logicTypeName, groupName, priority, entityId, userData);
        return tcs.Task;
    }
