...
public static class DataTableExtension
{
    ...
    public static void LoadDataTable(this DataTableComponent dataTableComponent, string dataTableName, string abTestGroupName, bool useBytes, object userData = null)
    {
        if (string.IsNullOrWhiteSpace(dataTableName))
        {
            ...
            GFTrace.Warning("DataTable", "Load.InvalidName");
            return;
        }
        ...
        {
            Log.Warning("Data table name is invalid.");
            GFTrace.Warning("DataTable", "Load.InvalidName", null, GFTrace.Data("name", dataTableName));
            return;
        }
        ...
        if (dataRowType == null)
        {
            ...
            GFTrace.Failure("DataTable", "Load.RowTypeMissing", null, GFTrace.Data("name", dataTableName, "rowType", dataRowClassName));
            return;
        }
