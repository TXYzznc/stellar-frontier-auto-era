...
namespace UGF.EditorTools
{
    ...
    public abstract class UtilityToolEditorBase : EditorToolBase
    {
        ...
        private void ScanSubPanelClass()
        {
            ...
            var allEditorTool = EditorToolTypeUtility.FindTypes(tp => tp.IsSubclassOf(typeof(UtilitySubToolBase)) && tp.GetCustomAttribute<EditorToolMenuAttribute>() != null && tp.GetCustomAttribute<EditorToolMenuAttribute>().OwnerType == this.GetType());
        ...
        private void SwitchSubPanel(int panelIdx)
        {
            ...
            mCompressMode = Mathf.Clamp(panelIdx, 0, subPanelsClass.Count - 1);
