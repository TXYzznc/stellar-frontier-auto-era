...
namespace UGF.EditorTools
{
    ...
    public class CompressToolEditor : EditorToolBase
    {
        ...
        private void ScanSubPanelClass()
        {
            ...
            var allEditorTool = EditorToolTypeUtility.FindTypes(tp => tp.IsClass && !tp.IsAbstract && tp.IsSubclassOf(typeof(CompressToolSubPanel)) && tp.GetCustomAttribute<EditorToolMenuAttribute>() != null);
