...
namespace UGF.EditorTools
{
    public class EditorToolbarExtension
    {
        ...
        static void ScanEditorToolClass()
        {
            ...
            var allEditorTool = EditorToolTypeUtility.FindTypes(tp => tp.IsClass && !tp.IsAbstract && tp.IsSubclassOf(typeof(EditorToolBase)) && tp.GetCustomAttribute(typeof(EditorToolMenuAttribute)) != null);
