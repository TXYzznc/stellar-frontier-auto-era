...
public static class UtilityBuiltin
{
    ...
    public static class AssetsPath
    {
        ...
        {
            return Utility.Text.Format("Assets/Game/DataTable/{0}.{1}", name, useBytes ? "bytes": "txt");
        }

        public static string GetSoundPath(string name)
        {
            return Utility.Text.Format("Assets/Game/Audio/{0}", name);
        }

        public static string GetScenePath(string name)
        {
            return Utility.Text.Format("Assets/Game/Scene/{0}.unity", name);
        }
        public static string GetEntityPath(string name)
        {
            return Utility.Text.Format("Assets/Game/Prefabs/Entity/{0}.prefab", name);
        }

        public static string GetUIFormPath(string v)
        {
            return Utility.Text.Format("Assets/Game/Prefabs/UI/{0}.prefab", v);
        }

        public static string GetTexturePath(string fileName)
        {
            return Utility.Text.Format("Assets/Game/Textures/{0}", fileName);
        }
        public static string GetSpritesPath(string fileName)
        {
            return Utility.Text.Format("Assets/Game/Sprites/{0}", fileName);
        }
        public static string GetConfigPath(string v, bool useBytes)
        {
            return Utility.Text.Format("Assets/Game/Config/{0}.{1}", v, useBytes ? "bytes" : "txt");
        }
        public static string GetScriptableConfigPath(string v)
        {
            return Utility.Text.Format("Assets/Game/ScriptableAssets/{0}.asset", v);
        }

        public static string GetPrefab(string v)
        {
            return Utility.Text.Format("Assets/Game/Prefabs/{0}.prefab", v);
        }

        public static string GetLanguagePath(string v, bool useBytes)
        {
            return Utility.Text.Format("Assets/Game/Language/{0}.{1}", v, useBytes ? "bytes" : "json");
        }
        ...
        {
            return Utility.Text.Format("Assets/Game/HotfixDlls/{0}.bytes", dllName);
        }
