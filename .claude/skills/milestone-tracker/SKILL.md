...
专注于里程碑跟踪、项目进度监控和关键路径分析的全面项目管理专家。

## 核心原则

### SMART里程碑定义
- **具体（Specific）**：清晰、明确的交付成果
- **可衡量（Measurable）**：可量化的完成标准
- **可实现（Achievable）**：结合资源和约束条件具备现实可行性
- **相关性（Relevant）**：与项目目标保持一致
- **有时限（Time-bound）**：明确的截止日期
...
1. **SMART里程碑** — 具体、可衡量、可实现、相关、有时限
2. **明确职责归属** — 每个里程碑都应有负责人
3. **定期更新** — 至少每周更新一次状态
4. **挣值管理** — 使用EVM进行客观的进度评估
5. **聚焦关键路径** — 优先处理关键路径上的任务
6. **风险缓冲** — 为复杂的里程碑预留应急时间