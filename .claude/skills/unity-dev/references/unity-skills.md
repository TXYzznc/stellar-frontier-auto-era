...
### Create UI Menu
```python
call_skill('ui_create_canvas', name='RootCanvas')
call_skill('ui_create_text', name='Label', parent='RootCanvas', text='', fontSize=48)
call_skill('ui_create_button', name='ActionButton', parent='RootCanvas', text='', width=200, height=50)
```
...
- `package_install_splines()` - Install the Unity Splines package version compatible with the project Unity 2022.3 editor.
...
echo '{"name":"目标对象","primitiveType":"Cube"}' | \
