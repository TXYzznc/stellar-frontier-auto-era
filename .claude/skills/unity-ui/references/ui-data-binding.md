...
In Unity 2022.3, use **SerializedObject binding** for Editor and Inspector UI. Runtime UI does not use a built-in data-binding system; update it explicitly from a presenter, controller, or view-model boundary.
...
- [Runtime Data Binding](https://docs.unity3d.com/2022.3/Documentation/Manual/UIE-runtime-binding.html)
- [UI Toolkit Controls](https://docs.unity3d.com/2022.3/Documentation/Manual/UIE-Controls.html)
